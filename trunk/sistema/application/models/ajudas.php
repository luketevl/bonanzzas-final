 ...
 */
class Ajudas extends DataMapper {

	// Uncomment and edit these two if the class has a model name that
	//   doesn't convert properly using the inflector_helper.
	// var $model = 'template';
	 var $table = 'custom_ajuda';
...
*/
	...
	*/
	...
	public function salvar($dados){
		$this->id 	 				= $dados['id'];
		$this->titulo_aju 			= $dados['titulo_aju'];
		$this->data_hora_aju 		= $dados['data_hora_aju'];
		$this->conteudo_aju 		= $dados['conteudo_aju'];
		$this->tipo_aju 			= $dados['tipo_aju'];
		$this->caminho_img_aju 		= $dados['caminho_img_aju'];
		$this->save();
	}

	public function get_ajuda($tipo=''){
		$this->where('tipo_aju', $tipo);
		$this->get();
