 ...
 */
class Produtos extends DataMapper {

	// Uncomment and edit these two if the class has a model name that
	//   doesn't convert properly using the inflector_helper.
	// var $model = 'template';
	 var $table = 'catalog_product_flat_1';
...
*/
	...
	*/
	...
	public function get_produtos_by_id($id= null){
		$this->where_in('entity_id',$id)->get();
		return $this->to_array();
	}
	
	public function get_id_produtos_by_categoria($id=0){
		$this->db->select('product_id');
		$this->db->from('catalog_category_product');
		$this->db->where('category_id',$id)->get();
		return $this->to_array();
	}
